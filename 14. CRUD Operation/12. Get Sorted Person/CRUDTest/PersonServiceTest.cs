...
namespace CRUDTest
{
    public class PersonServiceTest
    {
        ...
        public void GetSortPerson()
        {
            ...
            // Act
            List<PersonResponse> persons_list_from_sort = _personService.GetSortPersons(allPerson, nameof(PersonResponse.PersonName), SortOrderOptions.DESC);



            // Print person response list from add
            _testOutputHelper.WriteLine("Exception: ");
            foreach (var persons_from_sort in persons_list_from_sort)
            {
