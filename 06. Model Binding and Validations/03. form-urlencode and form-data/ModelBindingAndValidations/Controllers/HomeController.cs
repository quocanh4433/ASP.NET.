...
namespace IActionResultExample.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index([FromRoute]int? bookid, [FromRoute]bool? islogged, Book book)
        {
            ...
            return Content($"Book id: {bookid} - Is Logged: {islogged} - Object book: {book.ToString()}", "text/plain");
